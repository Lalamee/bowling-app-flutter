  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFFF6F6F9),
        elevation: 0,
        title: const Text('Личный кабинет', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: Color(0xFF1C1C1E))),
        centerTitle: false,
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const Text('Статус:', style: TextStyle(fontSize: 14, color: Color(0xFF6B6B6B))),
